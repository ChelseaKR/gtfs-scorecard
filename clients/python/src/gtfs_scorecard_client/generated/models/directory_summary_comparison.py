...
from ..models.directory_summary_comparison_required_measured_categories_item import (
    DirectorySummaryComparisonRequiredMeasuredCategoriesItem,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.directory_summary_comparison_exclusion_counts import (
        DirectorySummaryComparisonExclusionCounts,
    )
    from ..models.directory_summary_comparison_measured_category_cohorts import (
        DirectorySummaryComparisonMeasuredCategoryCohorts,
    )


T = TypeVar("T", bound="DirectorySummaryComparison")


@_attrs_define
class DirectorySummaryComparison:
    """
    Attributes:
        eligible_count (int):
        excluded_count (int):
        ...
        required_measured_categories (list[DirectorySummaryComparisonRequiredMeasuredCategoriesItem]):
        measured_category_cohorts (DirectorySummaryComparisonMeasuredCategoryCohorts):
        absolute_rankings_published (Literal[False]):
        individual_percentiles_published (Literal[False]):
        exclusion_counts (DirectorySummaryComparisonExclusionCounts):
        note (str):
    ...
    required_scoring_profile_id: str
    required_validator_version: str
    required_measured_categories: list[
        DirectorySummaryComparisonRequiredMeasuredCategoriesItem
    ]
    measured_category_cohorts: DirectorySummaryComparisonMeasuredCategoryCohorts
    absolute_rankings_published: Literal[False]
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        measured_category_cohorts = (
            DirectorySummaryComparisonMeasuredCategoryCohorts.from_dict(
        ...
        exclusion_counts = DirectorySummaryComparisonExclusionCounts.from_dict(
        ...
        directory_summary_comparison = cls(
            eligible_count=eligible_count,
            excluded_count=excluded_count,
            required_rubric_version=required_rubric_version,
            required_scoring_profile_id=required_scoring_profile_id,
        ...
        directory_summary_comparison.additional_properties = _d
        return directory_summary_comparison
