...
from ..models.by_location_comparison_required_measured_categories_item import (
    ByLocationComparisonRequiredMeasuredCategoriesItem,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.by_location_comparison_exclusion_counts import (
        ByLocationComparisonExclusionCounts,
    )
    from ..models.by_location_comparison_measured_category_cohorts import (
        ByLocationComparisonMeasuredCategoryCohorts,
    )


T = TypeVar("T", bound="ByLocationComparison")


@_attrs_define
class ByLocationComparison:
    """
    Attributes:
        eligible_count (int):
        excluded_count (int):
        ...
        required_measured_categories (list[ByLocationComparisonRequiredMeasuredCategoriesItem]):
        measured_category_cohorts (ByLocationComparisonMeasuredCategoryCohorts):
        exclusion_counts (ByLocationComparisonExclusionCounts):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        measured_category_cohorts = (
            ByLocationComparisonMeasuredCategoryCohorts.from_dict(
                _d.pop("measured_category_cohorts")
            )
        )

        exclusion_counts = ByLocationComparisonExclusionCounts.from_dict(
        ...
        by_location_comparison.additional_properties = _d
        return by_location_comparison
