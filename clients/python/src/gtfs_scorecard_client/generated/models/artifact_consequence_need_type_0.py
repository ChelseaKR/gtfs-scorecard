...
T = TypeVar("T", bound="ArtifactConsequenceNeedType0")


@_attrs_define
class ArtifactConsequenceNeedType0:
    """
    Attributes:
        tier (str | Unset):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        artifact_consequence_need_type_0 = cls(
            tier=tier,
            reason=reason,
        )

        artifact_consequence_need_type_0.additional_properties = _d
        return artifact_consequence_need_type_0
