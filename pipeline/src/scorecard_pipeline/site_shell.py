...
STATIC_NAV_PAGES: dict[str, str | None] = {
    ...
    # Program report bundle (docs/program-plan.md): linked from /support/ and
    # indexable since the tier opened; registered here so the shared nav and
    # footer stay in sync and the doc-stats sweep reads them.
