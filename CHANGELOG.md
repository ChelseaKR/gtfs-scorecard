...
- Let the world coverage map drill down into a country's subdivisions. Selecting
  ...
  from public-domain Natural Earth admin-1 data; a country without geometry, or a
  subdivision with none, degrades to the existing chip-and-list behavior. Fully
  keyboard-navigable and mobile-friendly, with no external map tiles.
