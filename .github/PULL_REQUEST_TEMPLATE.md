...
- [ ] Accessibility (any web/HTML change): the `Accessibility` axe gate and the contrast gate pass; a new page/route is added to `.pa11yci.json`; keyboard-operable with visible focus, correct labels/roles, no color-only meaning, respects reduced motion
